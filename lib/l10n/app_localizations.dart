...
abstract class AppLocalizations {
  ...
  /// No description provided for @dailyRecommendation.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @whyThisCoin.
  ///
  /// In en, this message translates to:
  /// **'Why this coin?'**
  String get whyThisCoin;
  ...
  /// No description provided for @chart1D.
  ///
  /// In en, this message translates to:
  /// **'1D'**
  String get chart1D;

  /// No description provided for @chart3D.
  ///
  /// In en, this message translates to:
  /// **'3D'**
  String get chart3D;
